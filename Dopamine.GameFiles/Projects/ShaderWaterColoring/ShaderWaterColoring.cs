...
namespace Dopamine.GameFiles.Projects.ShaderWaterColoring
{
    ...
    public class ShaderWaterColoring : BaseGameFile, IGameFile
    {
        ...
        public ShaderWaterColoring(IRenderer renderer, IEngineConfiguration configuration, IEngineFunctionalitys engineFunctionalitys)
        {
            ...
            Stream shaderFile = 
                new FileStream(_functionalitys.FindPathFileNameInDopamineGameFiles("Shader.frag", "Projects/ShaderWaterColoring"),
                FileMode.Open);
