...
namespace Dopamine.GameFiles.Projects.ShaderWaterColoringV2
{
    ...
    public class ShaderWaterColoringV2 : BaseGameFile, IGameFile
    {
        ...
        public ShaderWaterColoringV2(IRenderer renderer, IEngineConfiguration configuration, IEngineFunctionalitys engineFunctionalitys)
        {
            ...
            Stream shaderFile = 
                new FileStream(_functionalitys.FindPathFileNameInDopamineGameFiles("Shader.frag", "Projects/ShaderWaterColoringV2"),
                FileMode.Open);
