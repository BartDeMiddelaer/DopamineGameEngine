...
namespace Dopamine.GameFiles.Projects.ShaderRotatePolly
{
    ...
    public class ShaderRotatePolly : BaseGameFile, IGameFile
    {
        ...
        public ShaderRotatePolly(IRenderer renderer, IEngineConfiguration configuration, IEngineFunctionalitys engineFunctionalitys)
        {
            ...
            Stream shaderFile =
            new FileStream(
                _functionalitys.FindPathFileNameInDopamineGameFiles("Shader.frag", "Projects/ShaderRotatePolly"),
                FileMode.Open);
