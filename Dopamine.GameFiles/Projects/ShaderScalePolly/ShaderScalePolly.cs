...
namespace Dopamine.GameFiles.Projects.ShaderScalePolly
{
    ...
    public class ShaderScalePolly : BaseGameFile, IGameFile
    {
        ...
        public ShaderScalePolly(IRenderer renderer, IEngineConfiguration configuration, IEngineFunctionalitys engineFunctionalitys)
        {
            ...
            Stream shaderFile = 
                new FileStream(_functionalitys.FindPathFileNameInDopamineGameFiles("Shader.frag", "Projects/ShaderScalePolly"),
                FileMode.Open);
